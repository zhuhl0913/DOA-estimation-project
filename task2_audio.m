...
[X1,~]=audioread('Array_output/Array_output_01.wav');
[X2,~]=audioread('Array_output/Array_output_02.wav');
[X3,~]=audioread('Array_output/Array_output_03.wav');
[X4,fs]=audioread('Array_output/Array_output_04.wav');
[N1,b]=size(X1);

soundsc(X1,16000);


fra_per_win = 800;                               %每个window中frame的数量
